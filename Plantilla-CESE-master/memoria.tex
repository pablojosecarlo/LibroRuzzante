...
%\usepackage{incgraph,tikz} %para poner imagenes de fondo de página
\usepackage{pdfpages}  %para poner imágenes de pdf en la primer y última páginas

\usepackage{afterpage}  %para poner páginas en blanco con \afterpage{\blankpage}
\newcommand\blankpage{
    \null
    \thispagestyle{empty}
    \addtocounter{page}{-1}
...
\includepdf{./Figures/tapaLibroAdelanteISBN2}
...
%  [width=\paperwidth,height=\paperheight]{./Figures/tapaLibro01}



%\begin{figure}[H]
%    \centering
%    \includegraphics[width=1.0\textwidth]{./Figures/tapaLibro01}
% \end{figure}

%\begin{figure}[H]
%    \centering
%    \includegraphics[width=\paperwidth, height=\paperheight]{./Figures/tapaLibro01}
% \end{figure}
...
\textit{Copyright} \textcopyright 2021 by the authors
...
\vspace{1.5cm}
\LARGE\textbf{Autores:}\\
Dr. José E. Ruzzante \\ %\authornameUno
...
\hspace{20mm}{\large “Desde que todo, entonces, es causa y efecto, soportado y soporte, mediato e inmediato, y todo se mantiene unido por una cadena natural pero imperceptible, que enlaza entre sí las cosas más distantes y más diferentes, sostengo que es igualmente imposible conocer las partes sin conocer el todo y conocer el todo sin conocer las partes”.} 
...
\begin{flushright}
{\Large \textbf \textit . . . a mis amados hijos Verónica y Gualberto. Dondequiera que estén, adonde los lleve la vida, Dios los guarde y los guíe. \\
\vspace{5mm}
Pablo Alonso Castillo}
\end{flushright}
\vspace{1.0cm} 
...
\include{Chapters/Int_Magnetismo}
\include{Chapters/Susceptibilidad}
\include{Chapters/Paramagnetismo}
%\include{Chapters/canje}
\include{Chapters/Int_Ferromagnetismo}
\include{Chapters/Sist_Nanoscopicos}
\include{Chapters/Int_Superconductividad}
\include{Chapters/Mag_Superficial}
\include{Chapters/Sist_Biologicos}
%\include{Chapters/Sobrantes}
...
\include{Appendices/AppendixElectromagnetismoClasico}
\include{Appendices/AppendixTermodinamicaDelMagnetismo}
\include{Appendices/AppendixMetodoDeLaMemoriaMagnetica} 
%\include{Appendices/AppendixCamposMagneticosSuperficiales}
%\include{Appendices/AppendixLaminacionYTrenes}
\include{Appendices/AppendixMaterialesMagneticos}
\include{Appendices/AppendixMagnetismoEnAceros}
...
%\vfill
%contratapa
\includepdf{./Figures/paginaEnBlanco}

\includepdf{./Figures/tapaLibroAtrasISBN}
